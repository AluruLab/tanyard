...
def common_network(network_files: Iterable[str]):
    ...
    for net_file in network_files:
        ...
        src_rcds = rv_net.loc[rv_net.source_ind,
                              ['source_id',
                               'source_alias']].to_records(index=False)
        tgt_rcds = rv_net.loc[rv_net.target_ind,
                              ['target_id',
                               'target_alias']].to_records(index=False)
    ...
    for idx, net_file in enumerate(network_files):
        utfs = distinct_tfs[idx]
